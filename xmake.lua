...
target("scene")
    ...
    add_deps("engine")
    add_deps("assets")
    add_headerfiles("src/VCX/Scene/*.h")
    add_files      ("src/VCX/Scene/*.cpp")
...
target("simulation")
    ...
    add_packages("eigen")
    add_packages("fcl")
    add_headerfiles("src/VCX/Simulation/*.h")
    add_headerfiles("src/VCX/Simulation/*.hpp")
    add_files      ("src/VCX/Simulation/*.cpp")
